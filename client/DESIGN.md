...
DolphinZ IM follows Apple's design language — **near-invisible UI, single blue accent, generous whitespace**. The interface recedes so conversations take center stage. Every interactive element speaks in the same quiet blue (`#0066cc`); surfaces are white, pearl, or parchment; typography is SF Pro at 17px body with tight negative kerning at display sizes.
